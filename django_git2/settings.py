##
## This is configuration file for django_git2.
...
### Supported git repo type
# Avaiable types are 'parent', 'gitosis', 'cgit'
# if set a type, should setup the 'type'_path to parse.
GIT_SUPPORT = {
